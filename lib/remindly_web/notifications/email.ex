defmodule Remindly.Email do
  ...
  use Phoenix.Swoosh,
    view: RemindlyWeb.EmailView,
    layout: {RemindlyWeb.EmailView, :email_layout}
  ...
  defp from_name do
    Remindly.config(:mailer_default_from_name)
  end

  defp from_email do
    Remindly.config(:mailer_default_from_email)
  end
  ...
  def get_unsubscribe_url(user, email_kind) do
    Remindly.Accounts.NotificationSubscriptions.unsubscribe_url(user, email_kind)
  end
end
