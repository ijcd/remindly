defmodule RemindlyWeb.Helpers do
  ...
  def main_menu_items(current_user) do
    RemindlyWeb.Menus.main_menu_items(current_user)
  end

  def user_menu_items(current_user) do
    RemindlyWeb.Menus.user_menu_items(current_user)
  end

  def public_menu_items(current_user) do
    RemindlyWeb.Menus.public_menu_items(current_user)
  end

  def get_menu_item(name, current_user) do
    RemindlyWeb.Menus.get_link(name, current_user)
  end
