defmodule RemindlyWeb.DevResourcesLive do
          ...
          <.card>
            ...
            <.card_footer>
              <.button
                link_type="a"
                target="_blank"
                to="https://docs.petal.build/remindly-documentation/guides/creating-a-web-app-from-start-to-finish"
                color="primary"
              >
          ...
          <.card>
            ...
            <.card_footer>
              <.button link_type="a" to="/my-new-page" color="primary">
                <.icon name={:document_plus} class="w-4 h-4 mr-2" /> Create a page
              </.button>
            </.card_footer>
          </.card>
        </div>
