defmodule RemindlyWeb.PasswordlessAuthLive do
  @moduledoc """
  ...
  def mount(params, _session, socket) do
    socket =
      assign(socket,
        ...
        attempts: 0,
        sign_in_token: nil,
        token_changeset: build_token_changeset(%{}),
    ...
    case UserToken.check_pin(socket.assigns.auth_user, submitted_pin) do
      nil ->
        if socket.assigns.attempts >= @allowed_attempts do
          ...
          Remindly.Logs.log_async("passwordless_pin_too_many_incorrect_attempts", %{
