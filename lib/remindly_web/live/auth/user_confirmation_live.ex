defmodule RemindlyWeb.UserConfirmationLive do
      ...
      {:ok, user} ->
        ...
        redirect_path =
          if socket.assigns.current_user do
            # `after_confirm_email` should ensure the list of invitations is accurate
            invitations = Remindly.Orgs.list_invitations_by_user(socket.assigns.current_user)

            if Enum.any?(invitations),
              do: ~p"/app/users/org-invitations",
              else: RemindlyWeb.Helpers.home_path(socket.assigns.current_user)
          else
            ~p"/auth/sign-in"
          end
      ...
      :error ->
        ...
        case socket.assigns do
          %{current_user: %{confirmed_at: confirmed_at}} when not is_nil(confirmed_at) ->
            {:noreply,
             redirect(socket, to: RemindlyWeb.Helpers.home_path(socket.assigns.current_user))}
