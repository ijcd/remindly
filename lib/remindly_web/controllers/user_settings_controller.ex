defmodule RemindlyWeb.UserSettingsController do
  use RemindlyWeb, :controller

  alias Remindly.Accounts
  alias Remindly.Accounts.NotificationSubscriptions
  ...
  def update_password(conn, params) do
    ...
    case Accounts.update_user_password(user, password, user_params) do
      ...
      {:error, changeset} ->
        ...
        |> put_flash(
          :error,
          RemindlyWeb.CoreComponents.combine_changeset_error_messages(changeset)
        )
