defmodule RemindlyWeb.DevRoutes do
  @moduledoc """
  ...
  defmacro __using__(_opts \\ []) do
    quote do
      if Mix.env() in [:dev, :test] do
        ...
        live_session :dev, on_mount: [{RemindlyWeb.UserOnMountHooks, :maybe_assign_user}] do
          scope "/dev", RemindlyWeb do
          ...
          # Page Builder catch-all routes
          scope "/" do
            pipe_through :browser

            live "/:path_root", RemindlyWeb.PageBuilderLive
            live "/:path_root/:path_child", RemindlyWeb.PageBuilderLive
          end
        end
      end
    end
