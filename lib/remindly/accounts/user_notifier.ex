defmodule Remindly.Accounts.UserNotifier do
  @moduledoc """
  When sending an email we use the functions in Remindly.Email to generate the Email struct ready for Swoosh to send off.
  ...
  """
  alias Remindly.Email
  alias Remindly.Mailer
