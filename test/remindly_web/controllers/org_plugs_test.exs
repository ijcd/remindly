defmodule RemindlyWeb.OrgPlugsTest do
  use RemindlyWeb.ConnCase, async: true

  setup :register_and_sign_in_user

  setup do
    other_user = Remindly.AccountsFixtures.confirmed_user_fixture(%{is_onboarded: true})
    other_org = Remindly.OrgsFixtures.org_fixture(other_user)
